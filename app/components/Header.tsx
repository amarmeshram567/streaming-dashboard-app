...
//                         <Film className="w-7 h-7 text-primary group-hover:scale-110 transition" />
...
//                         <button className="lg:hidden hover:bg-accent rounded-lg p-2" onClick={() => setSearchOpen(true)}>
//                             <Search className="w-5 h-5" />
//                         </button>
//                         <button
//                             className="md:hidden hover:bg-accent rounded-lg p-2"
...
//             {/* SIDEBAR */}
//             <div
//                 className={`fixed top-0 left-0 h-full w-64 bg-neutral-900 text-white z-50 transform 
...
//                     <Link href="/" onClick={() => setSidebarOpen(false)} className="text-sm hover:text-primary">
//                         Home
//                     </Link>
//                     <Link href="/" onClick={() => setSidebarOpen(false)} className="text-sm hover:text-primary">
//                         Movies
...
//                 >
//                     <div
//                         className="bg-background w-full max-w-3xl max-h-[80vh] p-6 rounded-xl shadow-lg overflow-hidden flex flex-col"
